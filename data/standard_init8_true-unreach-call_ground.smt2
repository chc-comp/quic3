(set-info :original "/tmp/t/standard_init8_true-unreach-call_ground.pp.ms.o.bc")
...
(declare-rel main@bb89.i (Int (Array Int Int) Int Int ))
...
(declare-var main@%tmp98.i_0 Bool )
...
(rule (=> (and (main@bb79.i main@%tmp8.i_0
         ...
         (=> (and main@bb89.i_0 main@bb79.i_0) (= main@%x.0.i_1 main@%x.0.i_0)))
