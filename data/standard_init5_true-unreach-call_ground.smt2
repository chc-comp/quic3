(set-info :original "/tmp/t/standard_init5_true-unreach-call_ground.pp.ms.o.bc")
...
(declare-rel main@bb59.i (Int (Array Int Int) Int Int ))
...
(rule (=> (and (main@bb49.i main@%tmp8.i_0
         ...
         (=> (and main@bb59.i_0 main@bb49.i_0) (= main@%x.0.i_1 main@%x.0.i_0)))
