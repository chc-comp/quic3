(set-info :original "/tmp/t/standard_init9_true-unreach-call_ground.pp.ms.o.bc")
...
(declare-rel main@bb49.i (Int Int (Array Int Int) Int ))
(declare-rel main@bb59.i (Int Int (Array Int Int) Int ))
(declare-rel main@bb69.i (Int Int (Array Int Int) Int ))
(declare-rel main@bb79.i (Int Int (Array Int Int) Int ))
(declare-rel main@bb89.i (Int Int (Array Int Int) Int ))
(declare-rel main@bb99.i (Int (Array Int Int) Int Int ))
...
(declare-var main@%tmp105.i_0 Int )
(declare-var main@%tmp106.i_0 Int )
(declare-var main@%tmp108.i_0 Bool )
(declare-var main@%tmp102.i_0 Bool )
(declare-var main@%tmp92.i_0 Bool )
(declare-var main@%tmp82.i_0 Bool )
(declare-var main@%tmp72.i_0 Bool )
...
(declare-var main@%shadow.mem.6_1 (Array Int Int) )
...
(declare-var main@bb69.i_1 Bool )
(declare-var main@%shadow.mem.6_2 (Array Int Int) )
...
(declare-var main@%shadow.mem.7_1 (Array Int Int) )
...
(declare-var main@bb79.i_1 Bool )
(declare-var main@%shadow.mem.7_2 (Array Int Int) )
...
(declare-var main@%shadow.mem.8_1 (Array Int Int) )
(declare-var main@%i.8.i_1 Int )
(declare-var main@bb93.i_0 Bool )
(declare-var main@%_10_0 (Array Int Int) )
(declare-var main@%tmp97.i_0 Int )
(declare-var main@bb89.i_1 Bool )
(declare-var main@%shadow.mem.8_2 (Array Int Int) )
(declare-var main@%i.8.i_2 Int )
(declare-var main@bb99.i_0 Bool )
(declare-var main@%x.0.i_0 Int )
(declare-var main@%x.0.i_1 Int )
(declare-var main@bb103.i_0 Bool )
(declare-var main@bb113.i_0 Bool )
(declare-var main@%tmp115.i_0 Int )
(declare-var main@bb99.i_1 Bool )
(declare-var main@%x.0.i_2 Int )
(declare-var main@bb109.i_0 Bool )
...
(rule (=> (and (main@bb39.i main@%tmp8.i_0
         ...
         (=> (and main@bb49.i_0 main@bb39.i_0) (= main@%i.4.i_1 main@%i.4.i_0)))
...
(let ((a!2 (and (main@bb49.i main@%tmp8.i_0
  ...
  (=> a!2
      (main@bb49.i main@%tmp8.i_0
                   ...
                   main@%shadow.mem.4_2
                   main@%tmp2.i_0)))))
(rule (=> (and (main@bb49.i main@%tmp8.i_0
                      main@%i.4.i_0
                      main@%shadow.mem.4_0
                      main@%tmp2.i_0)
         true
         ...
         (=> (and main@bb59.i_0 main@bb49.i_0) (= main@%i.5.i_1 main@%i.5.i_0)))
    (main@bb59.i main@%tmp8.i_0
                 main@%i.5.i_1
                 main@%shadow.mem.5_1
                 main@%tmp2.i_0)))
(rule (let ((a!1 (=> main@bb63.i_0
...
(let ((a!2 (and (main@bb59.i main@%tmp8.i_0
  ...
  (=> a!2
      (main@bb59.i main@%tmp8.i_0
                   ...
                   main@%shadow.mem.5_2
                   main@%tmp2.i_0)))))
(rule (=> (and (main@bb59.i main@%tmp8.i_0
                      main@%i.5.i_0
                      main@%shadow.mem.5_0
                      main@%tmp2.i_0)
         true
         ...
         (=> (and main@bb69.i_0 main@bb59.i_0) (= main@%i.6.i_1 main@%i.6.i_0)))
    (main@bb69.i main@%tmp8.i_0
                 main@%i.6.i_1
                 main@%shadow.mem.6_1
                 main@%tmp2.i_0)))
(rule (let ((a!1 (=> main@bb73.i_0
...
(let ((a!2 (and (main@bb69.i main@%tmp8.i_0
  ...
  (=> a!2
      (main@bb69.i main@%tmp8.i_0
                   ...
                   main@%shadow.mem.6_2
                   main@%tmp2.i_0)))))
(rule (=> (and (main@bb69.i main@%tmp8.i_0
                      main@%i.6.i_0
                      main@%shadow.mem.6_0
                      main@%tmp2.i_0)
         true
         ...
         (=> (and main@bb79.i_0 main@bb69.i_0) (= main@%i.7.i_1 main@%i.7.i_0)))
...
(let ((a!2 (and (main@bb79.i main@%tmp8.i_0
  ...
  (=> a!2
      (main@bb79.i main@%tmp8.i_0
                   ...
                   main@%shadow.mem.7_2
                   main@%tmp2.i_0)))))
(rule (=> (and (main@bb79.i main@%tmp8.i_0
                      main@%i.7.i_0
                      main@%shadow.mem.7_0
                      main@%tmp2.i_0)
         true
         ...
         (=> (and main@bb89.i_0 main@bb79.i_0) (= main@%i.8.i_1 main@%i.8.i_0)))
    (main@bb89.i main@%tmp8.i_0
                 main@%i.8.i_1
                 main@%shadow.mem.8_1
                 main@%tmp2.i_0)))
(rule (let ((a!1 (=> main@bb93.i_0
...
(let ((a!2 (and (main@bb89.i main@%tmp8.i_0
  ...
  (=> a!2
      (main@bb89.i main@%tmp8.i_0
                   ...
                   main@%shadow.mem.8_2
                   main@%tmp2.i_0)))))
(rule (=> (and (main@bb89.i main@%tmp8.i_0
                      main@%i.8.i_0
                      main@%shadow.mem.8_0
                      main@%tmp2.i_0)
         true
         ...
         (=> (and main@bb99.i_0 main@bb89.i_0) (= main@%x.0.i_1 main@%x.0.i_0)))
    (main@bb99.i main@%tmp8.i_0
                 main@%shadow.mem.8_0
                 main@%x.0.i_1
                 main@%tmp2.i_0)))
(rule (let ((a!1 (=> main@bb103.i_0
...
(let ((a!2 (and (main@bb99.i main@%tmp8.i_0
                ...
                (=> main@bb103.i_0 (= main@%tmp108.i_0 (= main@%tmp106.i_0 50)))
...
(let ((a!2 (and (main@bb99.i main@%tmp8.i_0
                ...
                (=> (and main@bb109.i_0 main@bb103.i_0) (not main@%tmp108.i_0))
