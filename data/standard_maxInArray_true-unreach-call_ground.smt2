(set-info :original "/tmp/t/standard_maxInArray_true-unreach-call_ground.pp.ms.o.bc")
...
(declare-var main@%max.1.i_2 Int )
...
(declare-var main@%max.0.i_0 Int )
(declare-var main@%i.0.i_0 Int )
(declare-var main@%shadow.mem.0_1 (Array Int Int) )
(declare-var main@%max.0.i_1 Int )
...
(declare-var main@%max.1.i_0 Int )
(declare-var main@%max.1.i_1 Int )
(declare-var main@%tmp34.i_0 Int )
(declare-var main@bb12.i_1 Bool )
(declare-var main@%shadow.mem.0_2 (Array Int Int) )
(declare-var main@%max.0.i_2 Int )
