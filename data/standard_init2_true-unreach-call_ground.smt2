(set-info :original "/tmp/t/standard_init2_true-unreach-call_ground.pp.ms.o.bc")
(set-info :authors "SeaHorn v.0.1.0-rc3")
(declare-rel verifier.error (Bool Bool Bool ))
(declare-rel main@entry (Int ))
(declare-rel main@bb9.i (Int Int (Array Int Int) Int ))
(declare-rel main@bb19.i (Int Int (Array Int Int) Int ))
(declare-rel main@bb29.i (Int (Array Int Int) Int Int ))
...
(rule (=> (and (main@bb19.i main@%tmp8.i_0
         ...
         (=> (and main@bb29.i_0 main@bb19.i_0) (= main@%x.0.i_1 main@%x.0.i_0)))
