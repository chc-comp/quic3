(set-info :original "/tmp/t/standard_init3_true-unreach-call_ground.pp.ms.o.bc")
...
(declare-rel main@bb39.i (Int (Array Int Int) Int Int ))
...
(rule (=> (and (main@bb29.i main@%tmp8.i_0
         ...
         (=> (and main@bb39.i_0 main@bb29.i_0) (= main@%x.0.i_1 main@%x.0.i_0)))
