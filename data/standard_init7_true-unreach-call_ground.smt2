(set-info :original "/tmp/t/standard_init7_true-unreach-call_ground.pp.ms.o.bc")
...
(declare-rel main@bb79.i (Int (Array Int Int) Int Int ))
...
(rule (=> (and (main@bb69.i main@%tmp8.i_0
         ...
         (=> (and main@bb79.i_0 main@bb69.i_0) (= main@%x.0.i_1 main@%x.0.i_0)))
